...
class MalletScript:
    ...
    def GetKeysFileData(self):
        ...
        input_file = open(self.keys_file, 'r')
    ...
    def GetStateFileData(self):
        ...
        statefile = open(self.state_file, 'r')
    ...
    def GetTopicsFileData(self):
        ...
        tp_collection = []
        input_file = open(self.topics_file, 'r')
    ...
    class Mallet_FileTopicProportions:
        ...
        def build_vector(self):
            ...
            self.vector = range(0, len(self.sorted_topic_list))
            for index in range(0, len(self.sorted_topic_list)):
