...
function TWiC_Object(){ }
TWiC_Object.method("BindDataToNode", function(p_node){ });
TWiC_Object.method("AppendSVGandBindData", function(p_node){ });
TWiC_Object.prototype.s_objectCount = 0;
TWiC_Object.prototype.s_topicColors = null;

// TWiC_Cluster (inherits from TWiC_Object)
function TWiC_Cluster(svgContainer, center, radius, numberCircles, topicColors, topics, ideal_text, nodeIndex){
...
TWiC_Cluster.inherits(TWiC_Object);

TWiC_Cluster.prototype.colorHighlight = 0.50;
TWiC_Cluster.prototype.colorLolight = -0.50;


TWiC_Cluster.method("Load", function(){ });

TWiC_Cluster.method("BindDataToNode", function(p_node){
...
TWiC_Cluster.method("AppendSVGandBindData", function(p_node, pb_isRoot){
    ...
    this.cluster_group = p_node.append("g")
                               ...
                               .attr("id", "twic_cluster_" + TWiC_Object.prototype.s_objectCount)
                               ////.on("mouseenter", function(d) { TWiC_Cluster.prototype.DarkenClusterColors(d); })
                               .on("mouseout", function(d){ 
                                  TWiC_Cluster.prototype.ResetClusterColors(d);
                                  TWiC_Cluster.prototype.HighlightTopicinPanel(d, false);
                               });
                               //.on("click", this.ClickToZoom(this));
    TWiC_Object.prototype.s_objectCount += 1;
    ...
    for ( var index = 0; index < this.numberCircles; index++ ){ 
        ...
        if ( 1 == this.numberCircles ){
            ...
            data = {
                ...
                "hicolor" : TWiC_Cluster.prototype.shadeBlend(TWiC_Cluster.prototype.colorHighlight,
                                                              TWiC_Object.prototype.s_topicColors[this.topTopics[index][0]]),
                //"hicolor" : "white",
                // Lolight color
        ...
        this.cluster_group.append("circle")
                          ...
                          .on("mouseover", function(d){ 
                            TWiC_Cluster.prototype.HighlightTopicShapes(d, true);
                            TWiC_Cluster.prototype.HighlightTopicinPanel(d, true); 
                          })
                          .on("mouseout", function(d){ TWiC_Cluster.prototype.HighlightTopicinPanel(d, false); });
...
TWiC_Cluster.method("ResetClusterColors", function(d){
...
TWiC_Cluster.method("DarkenClusterColors", function(d){
    
    d3.selectAll(".topic_circle").style("fill", function(d){ return d.locolor; });
});

TWiC_Cluster.method("HighlightTopicShapes", function (data, highlight){
...
TWiC_Cluster.method("HighlightTopicinPanel", function(data, highlight){
...
TWiC_Cluster.method("shadeBlend", function(p,c0,c1) {
...
function TWiC_Rectangle(){

}
TWiC_Rectangle.inherits(TWiC_Object);