...
* [How to Use](#howtouse)
  ...
  * [Alternate Level - "Publication View"](#howtouse_publicationview)
...
![](\docs/images/used/twic_datashapes_topicwords_topicbar.png)
...
![](\docs/images/used/twic_datashapes_topicwords_textview.png)
...
![](\docs/images/used/twic_datashapes_topicwords_databar.png)
...
###Introduction
![](\docs/images/used/twic_panels_initialview_medium.png)
...
<br/>
![](\docs/images/used/twic_panels_allpanelsopen_medium.png)  
...
<br/>
![](\docs/images/used/twic_panels_initialview_highlighted_medium.png)


![](\docs/images/used/twic_panels_allpanelsopen_highlighted_medium.png)
...
<br/>
![](\docs/images/used/twic_panels_stoplight.png)
...
![](\docs/images/used/twic_panels_topicbar_medium.png)
...
![](\docs/images/used/twic_panels_databar_small.png)
...
<br/>
![](\docs/images/used/twic_panels_corpusview_small.png)
...
<br/>
![](\docs/images/used/twic_panels_corpusclusterview_medium.png)
...
<br/>
![](\docs/images/used/twic_panels_corpusclusterview_highlighting_medium.png)
...
<br/>
![](\docs/images/used/twic_panels_textclusterview_medium.png)
...
<br/>
![](\docs/images/used/twic_panels_textclusterview_highlighting_medium.png)
...
<br/>
![](\docs/images/used/twic_panels_textview.png)
...
![](\docs/images/used/twic_panels_publicationview_medium.png)
...
3. **Edit** the file `twic_config.yaml` with a text editor.
	...
	iii. _(Optional)_ Set the full and short corpus names. The full name is how your text will be referred to in the visualization (ex. `corpus_full_name: My Collection Name`. The short name is just an internal identifier for TWiC and MALLET (ex. `corpus_short_name: mycollection`. This will be the name of your MALLET output files.
...
5. **Start** a local server in the `twic` folder. (This is to prevent cross-site scripting (XSS) errors in the browser that stop TWiC from running.)
	...
	iii. Note: Though there are certainly other servers you could use to run TWiC, this current simple HTTP server via Python will suffice for most users.  
...
1. Open your web browser and type in the browser bar: `localhost:8080/twic.html`
